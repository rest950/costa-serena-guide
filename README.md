# 🔱 歌詩達郵輪 莎倫娜號 (Costa Serena) Deck 設施互動導覽

> **海上古羅馬．眾神之船 — 全船 13 個客用 Deck 設施、餐廳、泳池、娛樂與防迷路指南**
...
本專案為 **歌詩達郵輪 莎倫娜號 (Costa Serena)** 的**輕量化、Mobile-First 互動式靜態導覽網頁**與 **Markdown Deck 手冊**。

針對智慧型手機瀏覽體驗深度優化，提供即時設施搜尋、全 Deck 剖面速覽、手勢滑動切換甲板、個人專屬設施收藏、防迷路動線指南與全船餐飲速查等功能，方便旅客在郵輪旅程中隨時快速查閱。
...
* 🧭 **防迷路動線指南**：詳細說明 Deck 5 與 Deck 9 黃金貫通甲板、Deck 3/4 廚房阻隔走法與三大電梯群分佈。
* 🍽️ **全船餐飲速查**：免費包套餐廳與付費特色餐廳（Archipelago 米其林主廚餐廳、佛羅倫斯牛排館、Sushino 壽司吧、Pummid'Oro 披薩坊等）對照表，依 Costa 官方甲板圖校正。
* 🔗 **可分享的 Deck 網址**：每個 Deck 都有獨立網址（如 `#/deck/9`），重整後回到原處，也能直接把「我在 Deck 9」傳給同行的人。
...
| **客用甲板數 (Decks)** | 13 個（Deck 1 至 Deck 14，無 Deck 13） |
